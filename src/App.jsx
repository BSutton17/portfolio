        ...
        <section id="projects">
          ...
          <div className="project-container">
            ...
            <ProjectTile
              ...
              imageAlt="Overloard"
              onClick={() => viewModal(
                "Why make another chess clone when you can do something even cooler: make your own game. That is exactly what I did. Introducing Overloard, a multiplayer, strategy-based, tabletop game. The best part is you can play with anyone, all over the world.",
